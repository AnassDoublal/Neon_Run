...
//
//
//EnemyState* IdleEnemyState::handleInput(gpp::Events& input) {
//
...
//}
//
//void IdleEnemyState::update(Player& player) {}
//
//void IdleEnemyState::enter(Player& player)
//{
...
//}
//
//void IdleEnemyState::exit(Player& player)
//{
